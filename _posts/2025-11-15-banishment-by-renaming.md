...
What do you do when you don't want to bother with zeroing an array about 100 kilobytes on every map change? Just flag entries bz clearing their name string. One byte per entry, very economical.
